...
public class ArrayBlockingQueue<E> extends AbstractQueue<E>
     ...
     *
     * @param capacity 队列容量
     * @param fair 如果fair是true,表明锁是公平锁,先等待的线程会先获得锁
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
     ...
     * @throws IllegalStateException 当队列已满
     * @throws NullPointerException 如果待加入的元素为null
     */
    ...
    /**
     * 删除元素o
     * 如果队列中有多个元素o,只删除第一个找到的第一个元素
     *
     * @param o 需要删除的元素o
     * @return {@code true} 如果操作后对该队列有改变则返回true
     */
